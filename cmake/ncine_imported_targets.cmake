	...
	if(CMAKE_VERSION VERSION_GREATER_EQUAL "3.14.0")
		...
		elseif(APPLE)
			if(NCINE_ARM_PROCESSOR)
				set(NCINE_MACOS_LIBS_ARCHIVE "${NCINE_ROOT}/cmake/prebuilt/macos/jazz2-libraries-macos-arm64.tar.gz")
			else()
				set(NCINE_MACOS_LIBS_ARCHIVE "${NCINE_ROOT}/cmake/prebuilt/macos/jazz2-libraries-macos.tar.gz")
			endif()
			if(NOT EXISTS "${NCINE_MACOS_LIBS_ARCHIVE}")
				message(FATAL_ERROR "Bundled macOS dependencies not found at: ${NCINE_MACOS_LIBS_ARCHIVE}")
			endif()
			set(NCINE_LIBS_URL "file://${NCINE_MACOS_LIBS_ARCHIVE}")
		else()
